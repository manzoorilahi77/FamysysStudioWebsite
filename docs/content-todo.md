...
## Closing CTA success message (§4.16)

File: `src/presentation/components/DemoForm.tsx` (success-state confirmation copy)

"Someone from Famysys Studio will reply **within one business day**" is an operational commitment,
not fabricated content — but it's a promise the studio has to actually be able to keep. Confirm the
real turnaround before launch, or loosen the wording if one business day isn't reliably achievable.
